...
contract RWAPriceNotificationDispatcher is IRWAPriceNotificationDispatcher, NotificationWhitelister {
    ...
    function initialize(address _factory, address _tnft) external initializer {
        __NotificationWhitelister_init(_factory);
    ...
    function notify(
        ...
        uint256 tokenId = tnft.fingerprintTokens(fingerprint, 0);
        if (tokenId != 0) {
