...
contract OnSaleTrackerIL is IOnSaleTracker, AdminAccess {
    struct TokenArray {
        uint256[] tokenIds;
    }
    struct ContractItem {
    ...
    function setInstantLiquidity(address _instantLiquidity) external onlyAdmin {
    ...
    function tnftSalePlaced(
        ...
        require(msg.sender == instantLiquidity);
        ...
        if (place) {
            ...
            //something is added to instantLiquidity
            ...
            //something is removed from instantLiquidity
